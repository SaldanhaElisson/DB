...
public class RotaDAO extends ConexaoDB {
    ...
    private static final String SELECT_TIPO_ROTA_BY_ID = "SELECT id, descricao FROM rota WHERE id = ?";
    private static final String SELECT_ALL_TIPO_ROTA = "SELECT * FROM rota;";
    ...
    public List<Rota> selectAllRota() {
        ...
        try (PreparedStatement preparedStatement = prepararSQL(SELECT_ALL_TIPO_ROTA)) {
            ResultSet rs = preparedStatement.executeQuery();
